class SpecialitiesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to specialities_path, status: :see_other, notice: "Speciality was successfully destroyed." }
  ...
  private
    ...
    def speciality_params
      params.require(:speciality).permit(:code, :description)
    end
end
